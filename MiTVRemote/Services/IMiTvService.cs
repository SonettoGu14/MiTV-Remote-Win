...
public interface IMiTvService
{
    ...
    Task<MiTvDevice?> TryDiscoverAsync(string host, CancellationToken ct = default);
    ...
    Task SetVolumeWithFallbackAsync(string host, int volume, string signingMac, CancellationToken ct = default);
